    ...
    return (
        <>
            ...
            <aside
                ...
                id="logo-sidebar"
                className={`fixed top-0 left-0 z-40 w-64 h-screen transition-transform ${menuOpen ? 'translate-x-0' : '-translate-x-full'} sm:translate-x-0 bg-[#52381D]`}
                aria-label="Sidebar"
            >
                <div className="h-full px-3 py-4  overflow-y-auto bg-[#52381D] text-white dark:bg-gray-800">
                    <a href="#" className="flex items-center  ps-2.5 mb-5">
                        <img src="logo.svg" className="h-7  mb-11 sm:h-11" alt="Flowbite Logo" />
